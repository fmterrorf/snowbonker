...
FROM ${NODE_VERSION} as node_builder
WORKDIR /app
...
COPY --from=node_builder --chown=nobody:root /app/node_modules ./assets/node_modules
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/snowbonker ./
